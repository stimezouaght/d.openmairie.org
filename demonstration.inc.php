...
et bien plus encore.",
    ...
    "versions" => array(
        "4.10" => array(
            ...
            "href" => "a/openads/4.10",
            "autoinstall" => true,
            "svn" => "svn://scm.adullact.net/svn/openfoncier/tags/4.10.0",
            "db" => "pgsql",
        ),
    ),
);
...
$demos["openaria"] = array(
    ...
    "versions" => array(
        "1.6" => array(
            ...
            "href" => "a/openaria/1.6",
            "autoinstall" => true,
            "svn" => "svn://scm.adullact.net/svn/openaria/tags/1.6.0",
            "db" => "pgsql",
        ),
    ),
);
...
bien plus encore.",
    ...
    "versions" => array(
        "3.0" => array(
            ...
            "autoinstall" => true,
            "svn" => "svn://scm.adullact.net/svn/opencimetiere/tags/3.0.0",
            "db" => "pgsql",
        ),
        "4.0" => array(
            "title" => "4.0.0",
            "framework" => "4.9",
            "sig" => true,
            "href" => "a/opencimetiere/4.0",
            "autoinstall" => true,
            "svn" => "svn://scm.adullact.net/svn/opencimetiere/tags/4.0.0",
            "db" => "pgsql",
        ),
    ),
);
...
le transfert à l'insee des nouvelles inscription et bien plus encore.",
    ...
    "versions" => array(
        "5.0" => array(
            ...
            "href" => "a/openelec/5.0",
            "autoinstall" => true,
            "svn" => "svn://scm.adullact.net/svn/openelec/tags/5.0.0",
            "db" => "pgsql",
        ),
    ),
);
