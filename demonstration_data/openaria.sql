...
VALUES (nextval('om_utilisateur_seq'), 'Démonstration', 'contact@openmairie.org', 'demo', 'fe01ce2a7fbac8fafaed7c982a04e229', 1, 'db', 1);
update om_utilisateur set om_profil=(select om_profil from om_profil where om_profil.libelle='CADRE SI') where om_utilisateur.login='demo';
